function sS0 = setSystemInitialState(VoltageIdx, SDChainIdx, sP)
    ...
    % EQ = 1.5 * Uep - 0.5 * Up + 0.5 * (VP - VN) + 0.5 * (muN + muP) - 25
    f5 = 'EQ'; v5 = 1.5 * sP.Uep - 0.5 * sP.potentials.Up + ...
    ...
    %% Hamiltonians
    field7 = 'hamiltonians';
    % Feb/1/2011/A-2; no dependence on Quinone position xQ
